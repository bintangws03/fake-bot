...
const botSay = (data) => {
    return [
        "Perkenalkan saya babunya bintang. siapa nama kamu?",
...
function finishing() {
    pertanyaan.innerHTML =`Thank u ya ${usersData[0]} udah main sama babunya bintang 😉, kali-kali kita  ${usersData[2]} bareng ya!`
